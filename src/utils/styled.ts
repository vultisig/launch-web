...
const sharedColors: SharedColors = {
  ...
  neutral700: new ColorToken(225, 7, 24), //hsla(225, 7%, 24%, 1)
...
export const themes: Record<Theme, DefaultTheme> = {
  dark: {
    ...
    buttonDisabled: new ColorToken(216, 63, 18), //hsla(216, 63%, 18%, 1)
    buttonDisabledText: new ColorToken(214, 21, 60), //hsla(214, 21%, 60%, 1)
  ...
  light: {
    ...
    bgSuccess: new ColorToken(169, 63, 79), //hsla(169, 63%, 79%, 1)
    ...
    buttonDisabledText: new ColorToken(215, 16, 52), //hsla(215, 16%, 52%, 1)
